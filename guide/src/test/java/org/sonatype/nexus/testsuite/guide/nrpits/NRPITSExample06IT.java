...
public class NRPITSExample06IT
    extends NexusRunningParametrizedITSupport
{
    ...
    {
        return ParametersLoaders.testParameters( NRPITSExample06IT.class ).load();
    }

    public NRPITSExample06IT( final String nexusBundleCoordinates )
    {
